# Polls example with Jazz and React

Live version: [https://polls-demo.jazz.tools](https://polls-demo.jazz.tools)
...
```bash
npx create-jazz-app@latest --example polls --project-name polls
```
